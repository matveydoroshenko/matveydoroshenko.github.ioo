...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[104], {
    ...
    2104: function(e, t, r) {
        ...
        let b = a.default.forwardRef(function(e, t) {
            let r, n;
            let {href: c, as: g, children: b, prefetch: _, passHref: P, replace: j, shallow: R, scroll: O, locale: M, onClick: C, onMouseEnter: x, onTouchStart: E, legacyBehavior: k=!1} = e
              , w = o(e, ["href", "as", "children", "prefetch", "passHref", "replace", "shallow", "scroll", "locale", "onClick", "onMouseEnter", "onTouchStart", "legacyBehavior"]);
            r = b,
            k && ("string" == typeof r || "number" == typeof r) && (r = a.default.createElement("a", null, r));
            let S = !1 !== _
            ...
            let z = k ? n && "object" == typeof n && n.ref : t
              ...
              , K = a.default.useCallback(e=>{
                (D.current !== N || W.current !== U) && (q(),
                D.current = N,
                W.current = U),
                B(e),
            ...
            let$ = {
                ...
                onClick(e) {
                    ...
                    T && !e.defaultPrevented && function(e, t, r, n, o, l, c, i, s, f) {
            ...
            if (i.isAbsoluteUrl(N))
                $.href = N;
            else if (!k || P || "a" === n.type && !("href"in n.props)) {
                let e = void 0 !== M ? M : null == I ? void 0 : I.locale
                  , t = (null == I ? void 0 : I.isLocaleDomain) && h.getDomainLocale(N, e, null == I ? void 0 : I.locales, null == I ? void 0 : I.domainLocales);
                $.href = t || y.addBasePath(s.addLocale(N, e, null == I ? void 0 : I.defaultLocale))
            }
            return k ? a.default.cloneElement(n, $) : a.default.createElement("a", Object.assign({}, w, $), r)
        });
        t.default = b,
        ("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
            value: !0
    ...
    9840: function(e, t, r) {
        ...
        t.interpolateAs = function(e, t, r) {
            ...
            return i.every(e=>{
                ...
                (n || e in c) && (a = a.replace(o, r ? t.map(e=>encodeURIComponent(e)).join("/") : encodeURIComponent(t)) || "/")
            }
            ) || (a = ""),
            {
                params: i,
            ...
            try {
                ...
                if (i.isDynamicRoute(e.pathname) && e.searchParams && r) {
                    let r = n.searchParamsToUrlQuery(e.searchParams)
                      , {result: l, params: u} = s.interpolateAs(e.pathname, e.pathname, r);
                    l && (t = o.formatWithValidation({
                        pathname: l,
                        hash: e.hash,
                        query: a.omit(r, u)
                    }))
        ...
        t.getRouteMatcher = function(e) {
            ...
            return e=>{
                ...
                return Object.keys(r).forEach(e=>{
                    let t = r[e]
                      , n = o[t.pos];
                    void 0 !== n && (l[e] = ~n.indexOf("/") ? n.split("/").map(e=>a(e)) : t.repeat ? [a(n)] : a(n))
                }
                ),
                l
            }
                ...
                namedParameterizedRoute: n.map(e=>{
                        ...
                        return "/".concat(o.escapeStringRegexp(e));
                    {
                        let {key: t, optional: r, repeat: n} = l(e.slice(1, -1))
                          , o = t.replace(/\W/g, "")
                          , a = !1;
                        return (0 === o.length || o.length > 30) && (a = !0),
        ...
        function s() {
            return (s = n(function*(e, t) {
                ...
                if (r && c(r))
                    return n;
                if (!n) {
                    let t = '"'.concat(u(e), '.getInitialProps()" should resolve to an object. But found "').concat(n, '" instead.');
                    throw Error(t)
                }
                return n
