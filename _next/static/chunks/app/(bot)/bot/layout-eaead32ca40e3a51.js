  ...
  [479, 548],
  {
                ...
                ["meta", "base", "link", "style", "script"].forEach((e) => {
                  (function (e, t) {
                    let n = document.getElementsByTagName("head")[0],
                      ...
                      i = [];
                    for (
                      let t = 0, n = a.previousElementSibling;
                      t < l;
                      t++,
                        n =
    ...
    626: function (e, t, n) {
      ...
      function _(e) {
        ...
        u.useEffect(() => {
          let e = t || n;
          j.current || (a && e && m.has(e) && a(), (j.current = !0));
        }, [a, t, n]);
        let w = u.useRef(!1);
        if (
          (u.useEffect(() => {
          ...
          ("beforeInteractive" === c || "worker" === c) &&
            (y
              ? ((_[c] = (_[c] || []).concat([
                  r({ id: t, src: n, onLoad: o, onReady: a, onError: f }, p),
                ])),
                y(_))
              : g && g()
              ? m.add(t || n)
    ...
    7216: function (e, t, n) {
      ...
      var r = n(9268);
      function o() {
        return (0, r.jsx)("p", { children: "Загрузка..." });
      }
      var a = n(4965);
      n(7548);
      var l = n(6006),
      ...
      function s(e) {
        let { children: t } = e,
          { user: n, webApp: i } = (0, a.useTelegram)(),
          s = {
            "--tg-theme-bg-color": null == i ? void 0 : i.themeParams.bg_color,
            "--tg-theme-text-color":
              null == i ? void 0 : i.themeParams.text_color,
            "--tg-theme-hint-color":
              null == i ? void 0 : i.themeParams.hint_color,
            "--tg-theme-link-color":
              null == i ? void 0 : i.themeParams.link_color,
            "--tg-theme-button-color":
              null == i ? void 0 : i.themeParams.button_color,
            "--tg-theme-button-text-color":
              null == i ? void 0 : i.themeParams.button_text_color,
            "--tg-theme-secondary-bg-color":
              null == i ? void 0 : i.themeParams.secondary_bg_color,
          };
        return (0, r.jsx)("div", {
          className: u().default,
          children: n
            ...
            : (0, r.jsx)("div", {
                className: u().notBot,
                children: (0, r.jsx)("h1", { children: "Загрузка..." }),
              }),
        });
      }
    },
